...
proposals =
  fromList
    [ slideSymmetric 0.1 "small" (PWeight 5) Tune,
      slideSymmetric 1.0 "medium" (PWeight 2) Tune,
      slideSymmetric 5.0 "large" (PWeight 2) Tune,
      slide 1.0 4.0 "skewed" (PWeight 1) Tune
    ]
