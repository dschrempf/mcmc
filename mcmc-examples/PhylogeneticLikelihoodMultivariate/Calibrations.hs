...
-- each proposal.
calibrations :: HasLength a => [Calibration] -> Double -> Tree Length a -> [Log Double]
calibrations xs h t =
...
cladeStreptophyta :: Tree e Name -> (String, Path, Double, Double)
cladeEmbryophyta :: Tree e Name -> (String, Path, Double, Double)
cladeSetaphyta :: Tree e Name -> (String, Path, Double, Double)
cladePelliidae :: Tree e Name -> (String, Path, Double, Double)
cladeMarchantiales :: Tree e Name -> (String, Path, Double, Double)
cladeRicciales :: Tree e Name -> (String, Path, Double, Double)
cladeJungermanniidae :: Tree e Name -> (String, Path, Double, Double)
cladeJungermanniales :: Tree e Name -> (String, Path, Double, Double)
cladePorellineae :: Tree e Name -> (String, Path, Double, Double)
cladeRadulaceae :: Tree e Name -> (String, Path, Double, Double)
cladeFrullaniaceae :: Tree e Name -> (String, Path, Double, Double)
cladeSphagnopsida :: Tree e Name -> (String, Path, Double, Double)
cladePolytrichopsida :: Tree e Name -> (String, Path, Double, Double)
cladePolytrichaceae :: Tree e Name -> (String, Path, Double, Double)
cladePolytrichum :: Tree e Name -> (String, Path, Double, Double)
cladeFunariidae :: Tree e Name -> (String, Path, Double, Double)
cladeDicraniidae :: Tree e Name -> (String, Path, Double, Double)
cladeHypnanae :: Tree e Name -> (String, Path, Double, Double)
cladeTracheophyta :: Tree e Name -> (String, Path, Double, Double)
cladeLycopodiopphyta :: Tree e Name -> (String, Path, Double, Double)
cladeIsoetales :: Tree e Name -> (String, Path, Double, Double)
cladeSelaginellaceae :: Tree e Name -> (String, Path, Double, Double)
cladeStachygynandrum :: Tree e Name -> (String, Path, Double, Double)
cladeLycopodioideae :: Tree e Name -> (String, Path, Double, Double)
cladeEuphyllophyta :: Tree e Name -> (String, Path, Double, Double)
cladeMonilophyta :: Tree e Name -> (String, Path, Double, Double)
cladeEquisetum :: Tree e Name -> (String, Path, Double, Double)
cladeMarattiales :: Tree e Name -> (String, Path, Double, Double)
cladeEusporangiates :: Tree e Name -> (String, Path, Double, Double)
cladeGleicheniales :: Tree e Name -> (String, Path, Double, Double)
cladeCyatheales :: Tree e Name -> (String, Path, Double, Double)
cladeLindsaceae :: Tree e Name -> (String, Path, Double, Double)
cladeCystodiaceae :: Tree e Name -> (String, Path, Double, Double)
cladePteridaceae :: Tree e Name -> (String, Path, Double, Double)
cladeEupolypods :: Tree e Name -> (String, Path, Double, Double)
cladeSpermatophyta :: Tree e Name -> (String, Path, Double, Double)
cladeAcrogymnospermae :: Tree e Name -> (String, Path, Double, Double)
cladeCycadales :: Tree e Name -> (String, Path, Double, Double)
cladeGnetum :: Tree e Name -> (String, Path, Double, Double)
cladePinopsida :: Tree e Name -> (String, Path, Double, Double)
cladePinaceae :: Tree e Name -> (String, Path, Double, Double)
cladeParviflora :: Tree e Name -> (String, Path, Double, Double)
cladeRadiata :: Tree e Name -> (String, Path, Double, Double)
cladePonderosa :: Tree e Name -> (String, Path, Double, Double)
cladeTaxaceae :: Tree e Name -> (String, Path, Double, Double)
cladeJuniperus :: Tree e Name -> (String, Path, Double, Double)
cladeAngiospermae :: Tree e Name -> (String, Path, Double, Double)
cladeNympheales :: Tree e Name -> (String, Path, Double, Double)
cladeAustrobaileyales :: Tree e Name -> (String, Path, Double, Double)
cladeMesangiospermae :: Tree e Name -> (String, Path, Double, Double)
cladeMagnoliids :: Tree e Name -> (String, Path, Double, Double)
cladePiperales :: Tree e Name -> (String, Path, Double, Double)
cladeEudicots :: Tree e Name -> (String, Path, Double, Double)
cladeVitales :: Tree e Name -> (String, Path, Double, Double)
cladeRosids :: Tree e Name -> (String, Path, Double, Double)
cladeEricales :: Tree e Name -> (String, Path, Double, Double)
cladeMyrtales :: Tree e Name -> (String, Path, Double, Double)
cladeAsteraceae :: Tree e Name -> (String, Path, Double, Double)
cladeSalicaceae :: Tree e Name -> (String, Path, Double, Double)
cladeSolanales :: Tree e Name -> (String, Path, Double, Double)
cladeMonocots :: Tree e Name -> (String, Path, Double, Double)
cladeDioscoreales :: Tree e Name -> (String, Path, Double, Double)
cladeRiponogaceae :: Tree e Name -> (String, Path, Double, Double)
