...
proposals = fromList [slideUniformSymmetric 1.0 "Mu" (PWeight 1) Tune]
-- proposals = fromList [scaleUnbiased 1.6 "mu; scale" (PWeight 1) Tune]
-- proposals = fromList [slide 0.06 0.8 "mu; slide, biased" (PWeight 1) Tune]
-- proposals = fromList [scaleBactrian 0.3 0.3 "mu; scale bactrian" (PWeight 1) Tune]
