...
ss =
  Settings
    ...
    -- Burn in for 2000 generations. Auto tune every 200 iterations.
    ...
    -- the shortest trace possible. For example, Hamiltonian proposals require
    -- the trace for auto tuning masses.
    TraceAuto
